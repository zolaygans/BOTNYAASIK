...
*/
const A187 = '👾ZOLAYBOT👾'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/zolay_31'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6281999971634'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/E4KZMUKo8sBAeZfDxnIDIh'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'https://youtube.com/channel/UC9Jta2AfRlxpUBd8UNtI0Yg'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] ZOLAYBOT ready scan now!`);
});
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾ZOLAYBOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/zolay31_' ,MessageType.text);
}
else if (text == '#menu'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾ZOLAYBOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/zolay31_' ,MessageType.text);
}
